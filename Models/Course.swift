...
var courses = [
    Course(title: "Animations in SwiftUI", subtitle: "Build and animate an iOS app from scratch", caption: "20 sections - 3 hours", color: Color(#colorLiteral(red: 0.4705882353, green: 0.3137254902, blue: 0.9411764706, alpha: 1)), image: Image("Topic 1"), monthChart: "first-course-monthly-sales", weeklyChart: "first-course-weekly-sales", dailyChart: "first-course-daily-sales"),
    ...
    Course(title: "Build a SwiftUI app for iOS 15", subtitle: "Design and code a SwiftUI 3 app with custom layouts, animations and gestures using Xcode 13, SF Symbols 3, Concurrency and Searchable", caption: "21 sections - 4 hours", color: Color(#colorLiteral(red: 0.8705882353, green: 0.5594107557, blue: 0.8495429422, alpha: 1)), image: Image("Topic 1"), monthChart: "third-course-monthly-sales", weeklyChart: "third-course-weekly-sales", dailyChart: "third-course-daily-sales")
]
